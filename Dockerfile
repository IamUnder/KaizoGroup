...
ARG PUBLIC_PORTLEDGER_LEADS_URL
ARG PUBLIC_PORTLEDGER_LEADS_KEY
ENV PUBLIC_WEB3FORMS_ACCESS_KEY=$PUBLIC_WEB3FORMS_ACCESS_KEY \
    ...
    PUBLIC_PORTLEDGER_LEADS_URL=$PUBLIC_PORTLEDGER_LEADS_URL \
    PUBLIC_PORTLEDGER_LEADS_KEY=$PUBLIC_PORTLEDGER_LEADS_KEY
